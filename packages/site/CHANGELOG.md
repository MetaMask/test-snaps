...
## [4.1.1]
### Uncategorized
- Set up release automation as per the module template ([#101](https://github.com/MetaMask/test-snaps/pull/101))
- Remove undefined params ([#100](https://github.com/MetaMask/test-snaps/pull/100))
